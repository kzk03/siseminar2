...
from utils.evaluator2 import evaluate_model
...
def main():
    ...
    model, predictions, y = train_model(metrics_list, objective_list, args.output_dir)

    # 4. 評価と結果保存
    print("Evaluating model...")
    evaluate_model(y, model, predictions, args.output_dir)
